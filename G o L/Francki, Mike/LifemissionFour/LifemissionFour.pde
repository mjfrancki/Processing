...
//To change rules count(number of neighbor(s)) = 0 || 1 || 2        0=die, 1=stay the same, 2 = come to life   ex count3 = 2 if a cell has 3  neighbors it comes to life
...
//checks what rules to run 
  ...
  if (run) {
//switches the arrays and clears the old one  
    myArray = myNewArray;
    myNewArray= new boolean[50][50];/////////////////this one line fixed my whole code
  }

//draws circles an displays state of each rule
  fill(225, 225, 225);
...
void mousePressed() {
  ...
  fill(200, 0, 0);
// determines what cell you clicked 
...
//pressing number keys cycles through rule states for diffrent number of niegbers 
